                ...
                <Col lg={8} md={10} sm={12}>
                    ...
                    >
                        <Table  sx={{ minWidth: 300  }} aria-label="customized table">
                            ...
                            <TableHead>
                                <TableRow>
                                    <StyledTableCell align="center">{ t("orders.name") }</StyledTableCell>
                                    <StyledTableCell align="center">{ t("orders.link") }</StyledTableCell>
                            ...
                            {rows.map((row) => (
                                <StyledTableRow key={row.id}>
                                    ...
                                    <StyledTableCell align="center">
                                        <button onClick={()=>handleClickOpen()} className='btn app_button_1' >  حذف </button>
                                    </StyledTableCell>
                                    <StyledTableCell align="center">
